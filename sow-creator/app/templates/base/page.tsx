          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="rounded-md border bg-card">
              {recentSows.map((sow, index) => (
                <div
                  key={sow.id}
                  className={`flex items-center justify-between p-4 ${index !== recentSows.length - 1 ? "border-b" : ""
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <span
                      className={`text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider ${sow.status === "In Review"
